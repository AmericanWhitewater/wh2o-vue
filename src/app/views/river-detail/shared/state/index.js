...
export { default as projectsData } from './main-tab/projects-data'
export * from './main-tab/projects-data'

export { default as gageReadingsData } from './flow-tab/gage-readings-data'
export * from './flow-tab/gage-readings-data'

export { default as gageSourceData } from './flow-tab/gage-source-data'
export * from './flow-tab/gage-source-data'
...
export { default as mapData } from './map-tab/map-data'
export * from './map-tab/map-data'

export { default as accidentsData } from './accidents-tab/accidents-data'
export * from './accidents-tab/accidents-data'

export { default as creditsData } from './credits-tab/credits-data'
export * from './credits-tab/credits-data'
