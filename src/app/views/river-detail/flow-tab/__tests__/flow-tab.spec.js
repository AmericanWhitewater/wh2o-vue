...
import { GageChartControls } from '../components'
...
describe('FlowTab', () => {
  ...
  it('it shows loading gages block and skeleton text when loading gages', () => {
    mockStore.state.riverDetailState.reachGagesData.loading = true
  ...
  it('it shows no gages block when reach has no linked gages', () => {
    mockStore.state.riverDetailState.reachGagesData.loading = false
  ...
  it('shows no results block when no gage readings available', () => {
    ...
    mockStore.state.riverDetailState.gageReadingsData.data = []
