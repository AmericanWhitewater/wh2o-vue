...
import FlowChart from '@/app/views/river-detail/flow-tab/components/flow-chart/flow-chart.vue'
import { buildChart } from '../components/flow-chart/build-chart'

jest.mock('../components/flow-chart/build-chart')
