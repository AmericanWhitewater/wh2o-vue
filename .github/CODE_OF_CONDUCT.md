# American Whitewater Code of Conduct
...
reported by contacting the project team at info@americanwhitewater.org. All complaints
...
You can join the conversation at `americanwhitewater.slack.com`
...
2.  There's no need to notify the AW team that you have made an issue in
    AW's GitHub repositories. We check these several times a day, so we
...
4.  If you have a pressing bug fix, it is best to make a PR directly to get your
    issues addressed.
5.  `#wh2o-vue`: This channel is for questions about the wh2o-vue SPA
...
6.  `#design`: Please post any design questions with an in-context
